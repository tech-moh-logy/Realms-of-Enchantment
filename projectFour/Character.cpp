...
*/
Character::Character():name_{"NAMELESS"},race_{NONE},vitality_{10},armor_{5},level_{0},enemy_{false}
{
}

// void Character::display() {}
// void Character::eatTaintedStew() {}
/**
...
// void Character::eatTaintedStew() {
//     // Base class character eatTaintedStew implementation (not specified in the task).
//     // You can add common character eatTaintedStew behavior here.
// }
