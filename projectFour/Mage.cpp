...
void Mage::display() const { 
    ...
    std::cout << "They " << (can_summon_incarnate_ ? "can" : "cannot") << " summon an Incarnate." << std::endl; 
    std::cout << std::endl; 
} 
...
// It can not accsss private 
// void Mage::display() { 
//     std::cout << name_ << " is a Level " << level_ << " " << race_ << " MAGE." << std::endl; 
