...
void Ranger::display() const {
    ...
    for (int i = 0; i < affinities_.size(); i++) {
        if (affinities_[i] == affinities_.back()) {
            std::cout << affinities_[i];
        } else if (affinities_.size() == 1) {
            std::cout << affinities_[i];
        } else {
            std::cout << affinities_[i] << ", ";
        }
...
//     } else {
//         // setVitality(1);
//         for (int i = 0; affinities_.size(); i++) {
...
//   std::cout << "Animal Companion: " << (has_companion_() ? "TRUE" : "FALSE") << std::endl;
//   std::cout << "Arrows:" << std::endl;
//   for (const auto& [arrowType, quantity] : arrows_) {
//     std::cout << "\t" << arrowType << ": " << quantity << std::endl;
//   }
//   std::cout << "Affinities: " << affinities_ << std::endl;
// }
