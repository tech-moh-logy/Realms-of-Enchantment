...
class Character
{
    ...
    private:
        ...
        bool enemy_;
         ...
         // -------------- modified -----------------
        // Action queue: a queue of integers to store actions a character wants to take during their turn
        std::queue<int> action_queue_; // chnaged from "Action" to "integers"



        // Buff stack: a stack of Buff objects the character can use during their turn
